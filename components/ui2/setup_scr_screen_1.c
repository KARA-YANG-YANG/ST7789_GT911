...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->screen_1_btn_1_label, "HOME");
    ...
    lv_obj_set_pos(ui->screen_1_btn_1, 182, 292);
    lv_obj_set_size(ui->screen_1_btn_1, 56, 28);
