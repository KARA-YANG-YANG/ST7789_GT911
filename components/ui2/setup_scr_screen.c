...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->screen_img_1, &_cat_alpha_240x270);
    lv_img_set_pivot(ui->screen_img_1, 50,50);
    lv_img_set_angle(ui->screen_img_1, 0);
    lv_obj_set_pos(ui->screen_img_1, 0, 0);
    lv_obj_set_size(ui->screen_img_1, 240, 270);
    ...
    lv_label_set_text(ui->screen_NEXT_label, "NEXT SCREEN");
    ...
    lv_obj_set_pos(ui->screen_NEXT, 0, 270);
